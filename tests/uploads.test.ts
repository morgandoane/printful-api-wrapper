import fs from 'fs';
import type { ResponseLike } from 'printful-api-client/internal/to-file';
import { toFile } from 'printful-api-client/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('printful-api-client/core/uploads');
    await expect(
