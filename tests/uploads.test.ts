import fs from 'fs';
import type { ResponseLike } from 'mdd-printful-client/internal/to-file';
import { toFile } from 'mdd-printful-client/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('mdd-printful-client/core/uploads');
    await expect(
